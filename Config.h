...
// Четыре первых регистра настроек (S/N, номер Bind, поправка частоты и разрешение статистики
...
unsigned int  statCntr,statMin=0;   // счетчик очередной записи статистики и минут 
